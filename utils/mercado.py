...
def comprar_produto() -> None:
    if len(produtos) > 0:
        ...
        print(f'Ainda não existem produtos para vender.')
        sleep(2)
        menu()
...
def fechar_pedido() -> None:
     if len(carrinho) > 0:
        ...
        sleep(5)
         ...
         print('Ainda não existem produtosno carrinho.')
     sleep(2)
     menu()

def  paga_produto_por_codigo(codigo:int) -> Produto:
     p: Produto = None
